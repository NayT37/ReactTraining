            ...
            <div className="DefaultCourse">
                <div className="DefaultCourse_Info">
                    ...
                    <div className="CourseBottomInfo">
                        <img src={time_img} alt="Clock Icon" className="Image__Course" />
                        <p className="CourseBottomInfo__TxtInfo">{this.props.time}</p>
                        <img src={type_img} alt="Laptop Icon" className="Image__Course" />
                        <p className="CourseBottomInfo__TxtInfo">{this.props.trainingType}</p>
                    </div>
                </div>
                <div className="DefaultCourse_EndTag">
                    <p className="PriceTxt">{this.props.price}</p>
                    <button className="Button__Default"><img src={share_img} alt="Share Image"
                        className="Image__EndTag Flipped" /></button>
                </div>
            </div>
        );
    }
